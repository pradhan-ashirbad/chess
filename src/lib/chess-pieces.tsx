  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" {...props}>
      <g
        ...
        strokeLinejoin="round"
      >
        <path d="m6 13 3 13.5h27l3-13.5-13.5 13.5z" />
        <path
          d="M6 13s2 1.5 16.5 1.5S39 13 39 13"
          fill="none"
        />
        <path
          d="m22.5 4-2.5 4.5 2.5 2 2.5-2L22.5 4zM11.5 9a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zM22.5 9a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zM33.5 9a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"
        />
        <path d="m9 36.5 27 0-2.5-3-22 0z" />
        <path d="m9 36.5-2-3 2 3-2.5-3 2.5 3" />
        <path d="m6.5 33.5 32 0" fill="none" />
      </g>
    </svg>
  );
}
